...
type OrderedBlockProps = BlockContentProps & {
  listIndex: number;
};

export function OrderedBlock(props: OrderedBlockProps) {
  ...
  return (
    <>
      <span className="block__marker block__ordered" aria-hidden="true">
        {props.listIndex}.
      </span>
      <BlockInput
        block={props.block}
